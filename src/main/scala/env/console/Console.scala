...
import solver.DFSSolver.{CircularOrderStrategy, FixedOrderStrategy, MaxHolesScore, NextStepStrategy}
      ...
      choice match {
        ...
        case "solve" => {
          try {
            ...
            val strategyName = scala.io.StdIn.readLine("Your strategy (fixed/circular:maxholes): ")
